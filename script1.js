...
const previewing = document.getElementById("photo-preview");
...
uploadBtn.addEventListener("click",o => {
    fileInput.click();
})

dropArea.addEventListener("dragenter",o => {
    dropArea.classList.add("dragover");
})

dropArea.addEventListener("dragleave",o => {
...
fileInput.addEventListener("change",o => {
...
function handleFile(file){
    ...
    if(file.size > 500*1024){
        uploadNote.innerHTML = "File too large. pease upload a photo under 500KB.";
        uploadNote.classList.add("error");
        return;
    }
...
submitBtn.addEventListener("click",(e)=>{
    ...
    nameInfo.innerHTML = '';
    nameInfo.classList.remmove("error");
    emailInfo.innerHTML = ""
    emailInfo.classList.remove("error")
    githubInfo.innerHTML = ""
    githubInfo.classList.remove("error")
    uploadNote.innerHTML = "Upload your photo(JPG or PNG,max size: 500KB)"
    ...
    //validate email
    if(!email){
        emailInfo.innerHTML = `<img src="assets/images/icon-info.svg" alt="info icon" />Please provide your email address!`
